					...
					<div class="modal-body" >
						...
						<form method="POST" action="validation.php">
							...
							<div class="form-group">
								<label><i class="fa fa-user fa-2x"></i>Mail ID :</label>
								<input type="text" autocomplete="off" name="email" class="form-control" id="username" placeholder="Enter Mail ID" onkeypress="clear()">

							

								<label><i class="fa fa-lock fa-2x"></i>Password :</label>
								<input type="password" autocomplete="off" name="password" class="form-control" placeholder="Enter Password" id="password">


								</span>
								<button id="btn-login" name="submit" type="submit" >Login</button>
