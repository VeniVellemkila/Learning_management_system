...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style.css">
	   ...
	   <!----favicon setting-->
	<link rel="shortcut icon" type="text/css" href="img/Book.png">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Do Learning!</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
                 <!------Navigation menus starts---->
				<ul class="nav navbar-nav navbar-right">
					<li> <a href="">Home</a></li>
					<li> <a href="#myservice_section">Our Presents</a></li>
					<li> <a href="#work">Works</a></li>
					<li> <a href="#myfaq">FAQs</a></li>
					<!-- <li> <a href="logout.php" id="our-location" class="btn-success" ><?php echo $_SESSION['username'];   ?></a></li> -->
					<li><button class="nav-button"  onclick="over('user-logout')"> <a id="our-location" class="btn-success"><!--<?php echo $_SESSION['email'];   ?>--></a></button></li>
					<button class="nav-button nav-logout" id="user-logout"> <a href="logout.php" id="our-location" class="btn-success" >Logout</a></button>
				</ul>
				...
				<div class="slider-overlay">
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="cta-div">
								<!-- <h2>Are you ready to learn <?php echo $_SESSION['email'];   ?>!</h2>
								 --><br>
         	...
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<div class="wrapper-pro"><a href="programmingdemo.php" style="text-decoration: none; color: black;">	
         				<h3>PROGRAMMING</h3>
         				<p>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<div class="wrapper-pro"><a href="video tutorials\java\display_video_courses.php" style="text-decoration: none; color: black;">	
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<div class="wrapper-pro"><a href="online_quize/quizhome.php" style="text-decoration: none; color: black;">	
         				<h3>EXERCISE</h3>
         				   <!--  exercise/exercise.php -->
         				<p>
         					Here you will find problem programs for practice and their implementation also which will improve your learnign  skills
         				</p></a>
         			</div></div>
         		</div>
<!-- 
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												...
												here you can learn programming languages,Tech News and improve your Learnig and practice skills
											</p>
										</div>
									</div>
								</div>
